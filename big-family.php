...
<html lang="en">
  ...
  <title>Big Family | Casa Molle Villa & Golf</title>
  <?php require 'assets/partials/header.php'?>
	...
	<body>
		...
		<div class="mg-page-title main-img-big-family parallax">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<h2>Big Family</h2>
