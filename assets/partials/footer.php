			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6">
					<div class="widget">
						...
						<!-- LightWidget WIDGET -->
						<script src="https://cdn.lightwidget.com/widgets/lightwidget.js"></script><iframe src="//lightwidget.com/widgets/3cd28b28fc4f55efa605d1cbdb2362e5.html" scrolling="no" allowtransparency="true" class="lightwidget-widget" style="width:100%;border:0;overflow:hidden;"></iframe>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
					<div class="widget">
